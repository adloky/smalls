...
Черные также могут рассмотреть вариант 8...Ng6, намереваясь сыграть 9...Nf4, когда белым, вероятно, следовало бы сыграть 9.Qe4. Это необходимо проверить на практике.<addz start="9...Nf4"/>
